...
def generate_recruiter_posts(job_title: str, job_description: str, user_id: str, existing_users: List[str], job_id: str):
    """
    ...
    valid_post = Post(
        ...
        comments=[],
        likes=[{"user_id": uuid.uuid1(), "reaction_type": random.choice(list(ReactionType)), "created_at": int(datetime.datetime.now().timestamp())} for _ in range(10)],
    ...
    return valid_post.model_dump_json(), users.model_dump_json()
