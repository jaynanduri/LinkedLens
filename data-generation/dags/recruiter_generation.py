...
from src.utils.recruiter_gen_helper import create_company_user_map, user_recruiter_generation
...
load_data_task = PythonOperator(
    ...
    op_args=["linkedlens_data/filtered_data/tech_postings.parquet", ["company_name"], True],
    dag=dag,
)
