...
from src.utils.recruiter_gen_helper import create_company_user_map, generate_recruiter_for_companies
...
from src.utils.post_gen import generate_interview_exp_post
...
class TestDataGeneration(unittest.TestCase):
    ...
    def test_successful_generation(self, mock_uuid):
        ...
        # Call the function.
        post_json, user_json = generate_interview_exp_post(
        ...
        self.assertEqual(post_data['post_id'], "00000000-0000-0000-0000-000000000001")
        self.assertEqual(post_data['author'], "00000000-0000-0000-0000-000000000003")
        ...
        self.assertEqual(user_data['user_id'], "00000000-0000-0000-0000-000000000003")
